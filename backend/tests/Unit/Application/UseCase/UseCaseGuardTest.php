...
class UseCaseGuardTest extends TestCase
{
    ...
    public static function useCaseClassProvider(): iterable
    {
        $classes = [
            ...
            \App\Application\UseCase\Inscription\CreateInscriptionDraft\CreateInscriptionDraftUseCase::class,
            \App\Application\UseCase\Inscription\DeleteInscriptionDraft\DeleteInscriptionDraftUseCase::class,
            \App\Application\UseCase\Inscription\DeleteInscriptionDraftDocument\DeleteInscriptionDraftDocumentUseCase::class,
            \App\Application\UseCase\Inscription\GetInscriptionDraft\GetInscriptionDraftUseCase::class,
            \App\Application\UseCase\Inscription\SaveInscriptionDraft\SaveInscriptionDraftUseCase::class,
            \App\Application\UseCase\Inscription\UploadInscriptionDraftDocument\UploadInscriptionDraftDocumentUseCase::class,
            ...
            \App\Application\UseCase\License\ResendPaymentLink\ResendPaymentLinkUseCase::class,
            ...
            \App\Application\UseCase\Member\Media\DeleteNode\DeleteNodeUseCase::class,
            \App\Application\UseCase\Member\Media\GetMemberMedia\GetMemberMediaUseCase::class,
            ...
            \App\Application\UseCase\Member\SetFsgtRegistration\SetFsgtRegistrationUseCase::class,
            ...
            \App\Application\UseCase\Team\DeleteTeam\DeleteTeamUseCase::class,
            \App\Application\UseCase\Team\DownloadMyTeamMemberLicense\DownloadMyTeamMemberLicenseUseCase::class,
            \App\Application\UseCase\Team\DownloadMyTeamMemberPhoto\DownloadMyTeamMemberPhotoUseCase::class,
            \App\Application\UseCase\Team\GetAllTeams\GetAllTeamsUseCase::class,
            \App\Application\UseCase\Team\GetMyTeam\GetMyTeamUseCase::class,
            \App\Application\UseCase\Team\UpdateTeamRoster\UpdateTeamRosterUseCase::class,
