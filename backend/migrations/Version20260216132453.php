 ...
 */
final class Version20260216132453 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add team id to user';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE app_user ADD CONSTRAINT FK_88BDF3E9296CD8AE FOREIGN KEY (team_id) REFERENCES team (id) NOT DEFERRABLE');
