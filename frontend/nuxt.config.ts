...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        {
          ...
          content: "pn8nl5hSqc7don08zbejN8u2Gb4vnaPNdj8-9JFg4pA",
        },
      ...
      script: [
        {
          innerHTML: `<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
      ...
      noscript: [
        {
          innerHTML: `<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NGL84QZM" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>`,
  ...
  css: ["~/assets/css/global.css", "~/assets/css/home.css"],
});
